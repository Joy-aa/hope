...
public class AppConfig {
    ...
    private DASMStatusDAO dasmStatusDAO;// 20210924 新加
    ...
    public DASMStatusDAO getDasmStatusDAO() {
        return dasmStatusDAO;
    }

    public void setDasmStatusDAO(DASMStatusDAO dasmStatusDAO) {
        this.dasmStatusDAO = dasmStatusDAO;
    }
}
